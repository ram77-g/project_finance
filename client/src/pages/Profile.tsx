...
import {
  User, Mail, DollarSign, Globe, Save, Camera, Trash2, Upload, Check, X as XIcon
} from 'lucide-react';
...
const Profile: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl p-8 border border-white/20 dark:border-gray-700/20 shadow-lg">
